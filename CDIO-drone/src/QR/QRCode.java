...
{
    private ArrayList<QRListener> listener = new ArrayList<QRListener>();
...
//   		 System.out.println("QRCodeFound");
    ...
    public void addListener(QRListener listener)
    {
   	 this.listener.add(listener);
    }
    
    public void removeListener(QRListener listener)
    {
